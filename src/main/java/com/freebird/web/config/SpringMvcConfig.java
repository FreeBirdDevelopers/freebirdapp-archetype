...
import com.freebird.aspect.PerformanceLogForControllerAspect;
import com.freebird.web.exceptionresolver.SmartAppExceptionResolver;
import com.freebird.web.interceptor.HttpSessionInterceptor;
import com.freebird.web.utility.EhCacheAdminController;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages =	{	"com.freebird.web.controller",
									"com.freebird.web.interceptor"
								})
